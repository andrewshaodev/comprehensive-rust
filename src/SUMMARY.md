...
- [AIDL](android/aidl.md)
  - [Birthday Service Tutorial](android/aidl/birthday-service.md)
    - [Interface](android/aidl/birthday-service/interface.md)
    - [Service API](android/aidl/birthday-service/service-bindings.md)
    - [Service](android/aidl/birthday-service/service.md)
    - [Server](android/aidl/birthday-service/server.md)
    - [Deploy](android/aidl/birthday-service/deploy.md)
    - [Client](android/aidl/birthday-service/client.md)
    - [Changing API](android/aidl/birthday-service/changing-definition.md)
    - [Updating Implementations](android/aidl/birthday-service/changing-implementation.md)
